...
Two things that live elsewhere on purpose:

- **Backup / restore / failover runbooks** sit next to the scripts they document,
  in [`scripts/`](../scripts/) (`RUNBOOK.md`, `DB_RESTORE.md`, `LAPTOP_FAILOVER.md`).
